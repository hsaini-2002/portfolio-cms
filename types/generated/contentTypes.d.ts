...
export interface ApiAboutCarouselAboutCarousel
  extends Struct.CollectionTypeSchema {
  collectionName: 'about_carousels';
  info: {
    displayName: 'About Carousel';
    pluralName: 'about-carousels';
    singularName: 'about-carousel';
  };
  options: {
...
export interface ApiAboutImageAboutImage extends Struct.CollectionTypeSchema {
...
export interface ApiJournalJournal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    oneLiner: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPlayHeroPlayHero extends Struct.CollectionTypeSchema {
  collectionName: 'play_heroes';
  info: {
    displayName: 'Play Hero';
    pluralName: 'play-heroes';
    singularName: 'play-hero';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPlayProductPlayProduct extends Struct.CollectionTypeSchema {
  collectionName: 'play_products';
  info: {
    displayName: 'Play Product';
    pluralName: 'play-products';
    singularName: 'play-product';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    images: Schema.Attribute.Media<
      ...
      true
    >;
    isLaunching: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::play-product.play-product'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiWorkShowcaseFolderWorkShowcaseFolder
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    folderId: Schema.Attribute.Integer;
    items: Schema.Attribute.Component<'text.items', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::work-showcase-folder.work-showcase-folder'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
